...
import Tests.util.ScreenshotTest;
...
public class AndroidTest extends AndroidTestBase {
    ...
    public void test9kLink () throws InterruptedException, MalformedURLException {
            ...
            for (int j = 0; j < links[i].length; j++) {
                ...
                try {
                    ...
                    try {
                        ...
                        ScreenshotTest.TakeScreenshot(driver);
                        flag = false;
                    }
                }
        ...
        WriteExcelFile.writeResultTestLinks(filelocation, resultLinks, 0, 7);
    }
